...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('students_student', (
            ...
            ('current_affiliation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schools.School'])),
            ('belt_rank', self.gf('django.db.models.fields.CharField')(max_length=10, default='WHITE')),
            ('activity_type', self.gf('django.db.models.fields.CharField')(max_length=10, default='BJJ')),
            ('last_competition', self.gf('django.db.models.fields.DateTimeField')()),
    ...
    models = {
        ...
        'students.student': {
            ...
            'activity_type': ('django.db.models.fields.CharField', [], {'max_length': '10', 'default': "'BJJ'"}),
            'belt_rank': ('django.db.models.fields.CharField', [], {'max_length': '10', 'default': "'WHITE'"}),
            'current_affiliation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schools.School']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_competition': ('django.db.models.fields.DateTimeField', [], {}),
