...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('analytics_analysis', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('active_users_now', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('analytics', ['Analysis'])


    def backwards(self, orm):
        # Deleting model 'Analysis'
        db.delete_table('analytics_analysis')


    models = {
        'analytics.analysis': {
            'Meta': {'object_name': 'Analysis'},
            'active_users_now': ('django.db.models.fields.IntegerField', [], {}),
