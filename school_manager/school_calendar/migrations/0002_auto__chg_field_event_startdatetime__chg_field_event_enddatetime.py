...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.startdatetime'
        db.alter_column('school_calendar_event', 'startdatetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Event.enddatetime'
        db.alter_column('school_calendar_event', 'enddatetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.startdatetime'
        db.alter_column('school_calendar_event', 'startdatetime', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Event.enddatetime'
        db.alter_column('school_calendar_event', 'enddatetime', self.gf('django.db.models.fields.DateTimeField')())
