...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('school_calendar_event', (
            ...
            ('rule', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['school_calendar.RecurrenceRule'], blank=True)),
        ))
        db.send_create_signal('school_calendar', ['Event'])


        # Changing field 'RecurrenceRule.name'
        db.alter_column('school_calendar_recurrencerule', 'name', self.gf('django.db.models.fields.CharField')(max_length=36))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RecurrenceRule.name'
        db.alter_column('school_calendar_recurrencerule', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
