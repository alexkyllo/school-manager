...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('schools_school', (
            ...
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manager', to=orm['schools.Person'])),
        ))
        ...
        db.create_table(m2m_table_name, (
            ...
            ('person', models.ForeignKey(orm['schools.person'], null=False))
        ))
        db.create_unique(m2m_table_name, ['location_id', 'person_id'])
        ...
        db.create_unique(m2m_table_name, ['session_id', 'person_id'])
    ...
    models = {
        ...
        'schools.course': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'instructors'", 'to': "orm['schools.Person']", 'symmetrical': 'False'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schools.Location']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'students': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'students'", 'to': "orm['schools.Person']", 'symmetrical': 'False'})
        },
        'schools.location': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'managers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['schools.Person']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'schools.school': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'manager'", 'to': "orm['schools.Person']"}),
        ...
        'schools.session': {
            ...
            'students': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['schools.Person']", 'symmetrical': 'False'})
        }
    }
