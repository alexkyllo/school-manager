...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('school_calendar_event', 'startdatetime')

        # Deleting field 'Event.enddatetime'
        db.delete_column('school_calendar_event', 'enddatetime')
    ...
    models = {
        ...
        'school_calendar.event': {
            ...
            'enddatetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'startdatetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 4, 0, 0)'})
        },
